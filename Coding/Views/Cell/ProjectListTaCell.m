...
//项目名称、项目描述、收藏次数、关注次数、提交次数
@property(nonatomic,strong)UILabel *nameL, *desL, *starL, *watchL, *forkL;
...
- (void)setProject:(Project *)project {
    ...
    [_iconV sd_setImageWithURL:[_project.icon urlImageWithCodePathResize:2 * kProjectListTaCell_IconWidth] placeholderImage:kPlaceholderCodingSquareWidth(55.0)];
